          ...
          <nav class="navbar navbar-expand-md navbar-light">
            ...
            >
              ...
              <div class="others-option">
                <div v-if="!$auth.loggedIn" class="option-item">
                  <nuxt-link to="/login">Login</nuxt-link>
                </div>
                <div v-if="$auth.loggedIn" class="option-item">
                  <nuxt-link to="/login">{{ $auth.user.name }}</nuxt-link>
                </div>
